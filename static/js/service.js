...
var IdentityService = function() {
   ...
   */
  return {
    identityOrigin:  "https://localhost",   // CHANGE HOST
    identityBaseURL: "https://localhost",   // CHANGE HOST
     ...
     */
    loggedIn: function loggedIn(audience) {
      var op  = "logged_in";
    ...
    getVerifiedEmail: function getVerifiedEmail(m, message) {
      ...
      var loggedIn = this.loggedIn(origin(m)).result;
      if (loggedIn) {
